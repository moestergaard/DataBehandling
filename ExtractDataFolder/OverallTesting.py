...
def predictionsSVM(fileFirstMorning, fileSecondMorning, fileThirdMorning, fileFourthMorning, fileFirstEvening, fileSecondEvening, fileThirdEvening, locations, partOfData):
    ...
    print([otherDayM1, otherDayM2, otherDayM3, otherDayM4])
    ...
    print([otherTimeM1, otherTimeM2, otherTimeM3, otherTimeM4])
    ...
    print([otherDayE1, otherDayE2, otherDayE3])
    ...
    print([otherTimeE1, otherTimeE2, otherTimeE3])
