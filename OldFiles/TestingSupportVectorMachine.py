...
def main():
    ...
    DataSetSVM(locations, filename15Minute)
    ...
    smallDataSetTestedAgainstBigDataSetSVM(locations, filename15Minute, filename5Minute)
    smallDataSetTestedAgainstBigDataSetSVM(locations, filename15Minute, filename10Minute)
    smallDataSetTestedAgainstBigDataSetSVM(locations, filename15Minute, filenameUpdated)
    smallDataSetTestedAgainstBigDataSetSVM(locations, filename15Minute, filenameBigDataSet)
...
def smallDataSetTestedAgainstBigDataSetSVM(locations, filename, filenameTest):
...
def DataSetSVM(locations, filename):
    distinctBSSID, dataPoints = extractDistinctBSSIDAndNumberOfDataPoints(filename)
    trainingSamples, labelsTrainingSamples, testSamples, labelsTestSamples = extractData(filename, distinctBSSID, dataPoints, locations)
    ...
    accuracySVM(labelsTestSamples, predictionSVM, numberOfClasses = len(locations))
